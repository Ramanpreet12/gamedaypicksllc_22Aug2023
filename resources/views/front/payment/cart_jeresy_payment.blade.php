                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="billingInfo">
                                    ...
                                    <form action="{{ url('proceed_to_checkout_from_cart') }}" method="post" id="payment-form">
                                        @csrf
                                        ...
                                        @php
                                            $get_shoppingCart_session = session()->get('shoppingCart');
                                        @endphp
                                        <?php $cart_total = 0; ?>
                                     ...
                                     <input type="hidden" name="amount" id="amount" value="{{ $cart_total }}" readonly>
