                    ...
                    <div class="col-lg-4">
                        ...
                        <span class="font-weight-medium">${{ $get_jersey_from_admin_table->price }}</span>
                            ...
                            <div class="card-footer  bg-transparent">
                                ...
                                <a @if(Auth::user()) href="{{ route('proceed_to_checkout') }}" @else href="{{ route('login') }}" @endif >
                                    <button class="jersey_proceed_to_checkout_btn my-3 py-3" type="button" >Proceed To Checkout</button>
                                </a>
