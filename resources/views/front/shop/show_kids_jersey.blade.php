                        ...
                        <div class="jersey_form_box">
                            ...
                            @enderror --}}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        {{-- <span style="color: #DC3545" id="product_number_error_msg">{!! $errors->first('product_number', ':message') !!} </span> --}}
                            ...
                            <div class="jersey_radio_button cf">
                                <section class="plan cf">
                                    ...
                                    <input type="radio" name="gender" id="youth" value="youth" class="gender" checked><label
                                ...
                                @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        {{-- <input type="text" value="{{ $kids_product->price }}" name="jersey_price"
                                            id="jersey_price"> --}}
                                        @if (Auth::user())
                                            ...
                                            <section class="plan cf">
                                                ...
                                                <div class="youth_sizes">
                                                        ...
                                                        ><label class="{{ $size->productSize->product_size }}-label four gender_col size-button"
                                                            data-product_id="{{ $size->product_id }}" data-size_id="{{ $size->size_id }}"
                                ...
                                {{-- @if (Auth::user())
                                    <button class="buy-btn" type="submit" name="action" value="buy_now">Buy
                                        Now</button>
                                    <button class="cart-btn" id="reserve_btn" type="button" jersey_id="{{ $kids_product->id }}">
                                        Reserve</button>
                                @else
                                    <a href="{{ route('pre-sign-up') }}"><button class="buy-btn" type="button">Buy
                                            Now</button></a>
                                    <a href="{{ route('pre-sign-up') }}"><button class="cart-btn"
            ...
            <div class="slider">
                ...
                <ul id="autoWidth" class="cs-hidden">
                    ...
                    @foreach ($get_kids_product as $kids_product)
                        <!--1------------------------------------>
                        <li class="item-a">
                            {{-- <a href="{{ url('shop/' . $kids_product->jersey_url . '/' . $kids_product->id) }}"> --}}
                            <a
                                href="{{ url('pony-express-flag-football-shop/' . $kids_product->product_url . '/' . $kids_product->id) }}">
                                {{-- <a href="{{ url('shop/'.$kids_product->id.'/'.request()->segment(3)) }}"> --}}
                                <!--box-slider--------------->
                                <div class="box">
                                    <!--img-box---------->
                                    <div class="slide-img">
