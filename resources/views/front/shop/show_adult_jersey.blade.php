                                    ...
                                    <div class="mb-3">
                                        <div class="jersey_radio_button cf">
                                            <section class="plan cf">
                                                ...
                                                <input type="radio" name="gender" id="{{ $product->product_type }}" value="{{ $product->product_type }}" checked
                                                    class="gender"><label class="{{ $product->product_type }}-label four gender_col"
            ...
            <div class="slider">
                <ul id="autoWidth" class="cs-hidden">
                    @foreach ($get_product as $product)
                        ...
                        <!--1------------------------------------>
                        <li class="item-a">
                            <a href="{{ url('shop/' . $product->product_url . '/' . $product->id) }}">
                                ...
                                <div class="box">
                                    ...
                                    <div class="detail-box">
                                        ...
                                        class="price"></a>
                                        @endif
                                        {{-- <a href="#" class="price">${{ $product->product_variations[0]->product_price }}</a> --}}
                                    </div>
                                </div>
                            </a>
                        </li>
