                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                        <div class="products-single fix">
                                            <div class="box-img-hover">
                                                ...
                                                {{-- <img src="{{ asset('storage/images/jerseys/'.$product->product_images['0']->image_name) }}" class="img-fluid" alt="Image"> --}}
                                                {{-- <div class="mask-icon">
                                                    <ul>
                                                        <li><a href="{{ url('shop/'.$product->id.'/'.request()->segment(2)) }}" data-toggle="tooltip" data-placement="right" title="View"><i class="fa fa-eye"></i></a></li>
                                                    ...
                                                    <a class="cart" href="{{ url('cart/'.request()->segment(2)) }}">Add to Cart</a>
                                                </div> --}}
                                            </a>
                                            </div>
                                            <div class="why-text">
