    ...
    <!-- mainheader -->
        ...
        <section id="resultLeaderboard">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 id="matchREsult_head">{{$get_match_results_details->page_heading ? $get_match_results_details->page_heading : 'Match Results By Regions'}}</h2>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="seasonWeek row">
                            ...
                            <h5 class="col-auto matchREsult_text">{{$get_match_results_details->selected_season_heading ? $get_match_results_details->selected_season_heading : 'Selected Season'}} : {{ $season_name }}</h5>
                            <h6 class="col-auto totalPlayer matchREsult_text">{{$get_match_results_details->total_player_heading ? $get_match_results_details->total_player_heading : 'Total Players'}} : {{$total_players}}</h6>

                            <form action="{{ url('region-result/') }}" method="post" id="matchResultForm" class="col-md-auto formSpacing">
                                @csrf
                                <div class="inner_form d-flex align-items-center justify-content-center ">

                                    <div> <label for=""
                                            style=" margin-right:10px; font-weight:600;" class="matchREsult_text">{{$get_match_results_details->select_season_heading ? $get_match_results_details->select_season_heading : 'Select Season'}}:
                                        </label></div>
                ...
                @foreach ($total_win_loss as $key =>  $total_points) 
                    ...
                    <div class="fixtureContentPart">
                     <h5 class="matchREsult_text">{{$get_match_results_details->region_heading ? $get_match_results_details->region_heading : 'Region'}} : {{ $key  }} </h5> 
                            ...
                            <div class="modrenFixture matchREsult_button">
                                <div class="fixtureLogo">
                                    <div class="fixtureLogoIntro">
                                        <h3 style="font-size:0.95rem;" class="matchREsult_text">{{$get_match_results_details->players_total_win ? $get_match_results_details->players_total_win : 'Players Total WIN'}}</h3>
                                ...
                                <div class="fixtureLogo fixtureRight">
                                    <div class="fixtureLogoIntro">
                                        <h3  style="font-size:0.95rem;" class="matchREsult_text">{{$get_match_results_details->players_total_loss ? $get_match_results_details->players_total_loss : 'Players Total LOSS'}}</h3>
