                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div
                                                                ...
                                                                <div class="teamOne teamCard">
                                                                    ...
                                                                    <div style="min-width:100px">{{ $team->first_name }}
                                                                    </div>
                                                                </div>
                                                                <div class="versis">
                                                                    <h5>VS</h5>
                                                                ...
                                                                <div class="teamOne teamCard">
                                                                    ...
                                                                    <div style="min-width:100px">{{ $team->second_name }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                            ...
                                                            {{-- <div class="fixureMatch"> --}}
                                                                <div class="teamOne teamCard">
                                                                    <img src="{{ asset('storage/images/team_logo/' . get_team_logo($team->team_win)) }}"
                                                                        alt="" class="img-fluid" style="height: 30px">
                                                        ...
                                                        <td>
                                                            <div class="teamOne teamCard">
                                                                ...
                                                                <div style="min-width:100px">{{ $team->user_team }}</div>
                                                            </div>
                                                        </td>
