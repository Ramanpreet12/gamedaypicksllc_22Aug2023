            ...
            <div id="horizontal-form" class="p-5">
                <div class="preview">
                    ...
                    <div class="form-inline mt-3 mb-3">
                        <label for="copyright_color" class="font-medium form-label sm:w-60">Copyright Color<span class="text-danger"></span></label>
                        <div class="input-group">
                            <input id="copyright_color" type="color" class="form-control" placeholder="color code for Privacy Policy" aria-describedby="copyright_color" name="copyright_color" style="width: 20rem;" value="{{$general->copyright_color}}">
                        </div>
                    </div>
