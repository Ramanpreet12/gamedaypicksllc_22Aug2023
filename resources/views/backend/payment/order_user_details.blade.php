...
@section('subhead')
    <title>{{ $general->name ? $general->name : 'NFL' }} | Users Details</title>
@endsection
...
@section('subcontent')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <a href="{{ route('admin/order-payments') }}"><button class="btn btn-primary">Back</button></a>
    </div>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered">
                    <tr>
                        <td><b>Order ID : </b></td>
                        <td>{{ $get_users_order_details->order_id ?? '' }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $get_users_order_details->product_jersy_number ?? '' }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst($get_users_order_details->product_gender)  ?? '' }}</td>
                    </tr>
                        ...
                        <td>
                            @if (!empty($get_users_order_details->image_name))
                                <img class="rounded-md w-40" alt="Product Image"
                                    src="{{ asset('storage/images/products/' . $get_users_order_details->image_name) }}">
                            @else
                                <img class="rounded-md w-40" alt="User Image"
