...
@endif
    ...
    <div class="intro-y box mt-5">
        ...
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            <a href="{{ route('products.edit', $id) }}"><button class="btn btn-primary">Back</button></a>
        </div>
        <form action="{{ url('admin/products/add-variants/' . $id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
