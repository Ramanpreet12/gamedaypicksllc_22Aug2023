...
@section('subcontent')
    ...
    <div class="intro-y box mt-5">
        ...
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            <a href="{{ route('products.edit',$product_id) }}"><button class="btn btn-primary">Back</button></a>
        </div>
        <form action="{{ url('admin/products/'.$product_id.'/edit-variants/'.$variant_id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            @method('PUT')
