...
Route::prefix('admin')->middleware(['isAdmin'])->group(function () {
    ...
    Route::get('product-image/delete/{id}', [ProductController::class, 'deleteProductImage']);
    Route::get('jersey-image/delete/{id}', [AdminJerseyController::class, 'deleteJerseyImage']);

    // add variants
    // Route::get('products/add-variants/{id}', [ProductController::class, 'addVariant'])->name('product.add-variants');

    Route::match(['get', 'post'], 'products/add-variants/{id}', [ProductController::class, 'addVariant']);
    Route::match(['get', 'put'], 'products/{product_id}/edit-variants/{variant_id}', [ProductController::class, 'editVariant']);
    Route::get('product-variation/delete/{variant_id}', [ProductController::class, 'deleteProductVariant']);
    // product variations
